...
inkscape resources/card-batanimo.svg -i layer41 -j -C --export-png=build/measure.forhtml.png --export-area=11:20:228:358
inkscape resources/card-batanimo.svg -i layer41 -j -C --export-png=build/measure.forswift.png
...
for layerId in {1..36}; do
    ...
    inkscape resources/card-batanimo.svg -i layer${layerId} -j -C --export-png=build/card${label}.scene.forswift.png 
    inkscape resources/card-batanimo.svg -i layer${layerId} -j -C --export-png=build/card${label}.scene.forhtml.png --export-area=11:20:228:358
...
for layerId in {37..37}; do
    ...
    # exports two versions of the drawing scene
    inkscape resources/card-batanimo.svg -i layer${layerId} -j -C --export-png=build/card-batanimo-${label}.forswift.png
    inkscape resources/card-batanimo.svg -i layer${layerId} -j -C --export-png=build/card-batanimo-${label}.png --export-area=11:20:228:358
